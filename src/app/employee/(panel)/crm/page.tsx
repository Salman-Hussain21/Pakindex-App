...
import { Users, MoreHorizontal, Calendar, Mic, CheckSquare, XCircle, BrainCircuit, Plus, Flame, Phone } from "lucide-react";
                    ...
                    >
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        {(() => {
                          ...
                          return (
                            <span className={`inline-flex items-center gap-1 text-[10px] font-bold rounded-full border px-2 py-0.5 ${b2b.badgeBg}`}>
                        ...
                        {lead.phone && (
                          <div className="flex items-center gap-1">
                            <a href={`tel:${lead.phone}`} className="text-gray-400 hover:text-brand-600" title="Call"><Phone size={12} /></a>
                            <a href={`https://wa.me/${lead.phone.replace(/[^0-9]/g, "")}`} target="_blank" rel="noreferrer" className="text-[10px] font-bold text-emerald-600 hover:text-emerald-700" title="WhatsApp">💬</a>
                          </div>
                        )}
                      </div>
