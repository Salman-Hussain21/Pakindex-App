...
const STYLES: Record<string, string> = {
  ...
  approved: "bg-emerald-50 text-emerald-700 ring-emerald-200", // Corporate colorway update
  ...
  active: "bg-emerald-50 text-emerald-700 ring-emerald-200", // Corporate colorway update
